const Chart = () => {
    ...
    <div className="flex m-4 gap-2">
      <div className="flex-1 px-2 justify-center w-16 bg-gray-600 shadow rounded h-300px">
        <div className="">
      ...
      <div className="flex-1 px-2 justify-center w-16 bg-gray-600 shadow rounded max-h-300px">
      <div className="">
